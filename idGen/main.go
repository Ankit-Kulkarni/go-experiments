...
func main() {
	...
	fmt.Println("Binary representation:", binaryStr) // 11001001011010010000000000000111111100100

	var est esTimeBasedUUIDGenerator
	x := est.NextID()
	fmt.Println("x is ", x)
...
// learning 1: A millisecond requires 41 bit representaiton - Example : 11001001011010010000000000000111111100100 means 1730100072420
// learning 2: To represent a ms in uint64, first 23 bits will be 0 and then actual ms
// learning 3: 00000000 0000000 00000000 0000000 00000001 0000000  00100100 0010010   (typical 64 bit representation of bits  . This is 8 bytes space seperated)
// So total 6 bytes are required to represent a TS in MS
//
